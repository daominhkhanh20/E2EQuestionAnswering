...
sed -i 's/INSERT_TITLE_HERE/model-compile-v3/g' model_compile/dataset-metadata.json
sed -i 's/INSERT_SLUG_HERE/model-compile-v3/g' model_compile/dataset-metadata.json
